...
$(document).ready(function() { 
	...
	$(".menu-karta > li > a.active").append('<strong></strong>');

	if ($('#main-menu-karta').width() == '940' || $('#main-menu-karta').width() == '748') {BorderHeight2 = '42px'}
		else {BorderHeight2 = '42px'}
		
		

	
	$('.menu-karta > li > a.active strong, .menu-karta > li.sfHover > a strong').css({height:BorderHeight2});
	
	$(".menu-karta > li > a").hover(
		function(){
