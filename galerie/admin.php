...
<head>
    ...
    <meta charset="utf-8" />
    <title>Galerie MZ PARTNER</title>
      ...
      <br>
        ...
        <?
          ...
          while ($zaznam = mysqli_fetch_array($res)) {
            ...
            $sqlm="SELECT nazev FROM content_Menu where id_content_Menu = ".$idc;  
      ...
      { // BEGIN function PridatDokument
        ...
        ?>
          ...
          <tr>
            ...
            <select name="idcmenu">
            <?
              $sql="Select * from content_Menu where id_hlavni_Menu=6";
              $res = PrSql($spojeni,$sql);
              while ($zaznam = mysqli_fetch_array($res)) {
              
              ?>
                <option <?if ($zaznam["id_content_Menu"]==$idcmenu) echo "selected"; ?> 
                value="<?echo $zaznam["id_content_Menu"]?>"><?echo $zaznam["nazev"]?></option>
              <?
...
<body>
    <div class="page">
       ...
       <span id="admin">Galerie MZ PT</span>
        ...
        <div id="footer">
       <span><a href="../admin48156.php?cmd=zobrazhlavni_Menu">Zpět na administraci hlavního menu</a></span> 
